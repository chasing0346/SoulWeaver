...
<img src="assets/screenshots/intake-scope.png" alt="Intake 与授权范围确认" width="720">

**分块进度与并行 Worker 状态**

<img src="assets/screenshots/worker-progress.png" alt="分块进度与并行 Worker 状态" width="720">

**Memories、Persona、Style 与 Behavior 草稿预览**

<img src="assets/screenshots/draft-preview.png" alt="Memories、Persona、Style 与 Behavior 草稿预览" width="720">
